odoo.define('abc.snippet_custom', function (require) {
...
publicWidget.registry.CustomSnippets = publicWidget.Widget.extend({
    selector: '.snippet_custom',
    ...
    _fetch: function () {
        return this._rpc({
            route: '/custom_snippets/products/view_products',
        })
        debugger;
            // .then(res => {
